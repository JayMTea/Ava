// Line icons (Lucide-style, currentColor). Ported from the legacy ICONS object.
// Rendered via an <Icon> component so any glyph is `<Icon name="send" />`.
...
export const ICONS: Record<string, string> = {
  ...
  mic:
    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="2" width="6" height="12" rx="3"/><path d="M5 10v2a7 7 0 0 0 14 0v-2"/><line x1="12" x2="12" y1="19" y2="22"/></svg>',
  send:
  ...
  // A filled square: the universal "stop what is running" glyph, and
  // deliberately not an X (which reads as dismiss/close, not interrupt).
  stop:
  ...
  file:
    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"/><path d="M14 2v5h6"/><path d="M16 13H8"/><path d="M16 17H8"/><path d="M10 9H8"/></svg>',
  image:
  ...
  ghost:
    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 10h.01"/><path d="M15 10h.01"/><path d="M12 2a8 8 0 0 0-8 8v12l3-3 2.5 2.5L12 19l2.5 2.5L17 19l3 3V10a8 8 0 0 0-8-8Z"/></svg>',
  alert:
  ...
  // The sidebar's right-click menu (lib/openWindow.ts, rendered by
  // lib/ContextMenu.tsx): an arrow leaving its box for "open in new tab", a
  // window frame for "open in new window". `copy` above serves "Copy link".
  external:
