...
| contracts | `test_30_fixture_contract.py` | marketing/ fixtures never drift from the real API shapes |
...
- Tier 3 needs `frontend/dist` built and `marketing/node_modules` installed;
